...
export const metadata: Metadata = {
  title: "Pricing — Comptia A Core 1 Premium",
  description: "Unlock unlimited Comptia A Core 1 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=comptia-a-core-1&cadence=annual`;
