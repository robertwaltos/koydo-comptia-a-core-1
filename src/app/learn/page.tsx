...
export const metadata: Metadata = {
  title: "Learn — CompTIA A+ Core 1 Practice",
  description: "Study and practice for CompTIA A+ Core 1. Choose your subject and start preparing.",
};
