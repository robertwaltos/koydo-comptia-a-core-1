...
export const metadata: Metadata = {
  title: "Koydo CompTIA A+ Core 1 — Free Exam Prep",
  description: "Comprehensive CompTIA A+ Core 1 preparation. Practice tests, AI tutor, score tracking. This app is a study aid based on publicly available syllabus and exam patterns. Not affiliated with any official examination authority.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] px-4 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            Ace CompTIA A+ Core 1 with Koydo
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for CompTIA A+ Core 1?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real CompTIA A+ Core 1 format." },
